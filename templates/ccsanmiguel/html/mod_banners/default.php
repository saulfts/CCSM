...
<div id="bannergroup-<?php echo $module->id; ?>" class="bannergroup">
	...
	<?php if (count($list)){ ?>
		<div class="ot-items text-center<?php echo $slide; ?>">
			...
			<?php if (strpos( $params->get ('moduleclass_sfx'), 'carousel-slide')!==false){ ?>
				...
				<a class="carousel-control control-light control-box left" href="#bannergroup-<?php echo $module->id; ?> .ot-items" data-slide="prev">
					<span class="glyphicon glyphicon-chevron-left"></span>
					<!-- <span class="fa fa-2x fa-angle-left"></span> -->
				</a>
				<!-- "next page" action -->
				<a class="carousel-control control-light control-box right" href="#bannergroup-<?php echo $module->id; ?> .ot-items" data-slide="next">
