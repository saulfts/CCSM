...
$Browsecellwidth = ' col-xs-12 col-sm-' . floor (12 / $this->params->get('latestItemsCols'));
?>

<!-- Start K2 Latest Layout -->
<div class="page-content">
<div id="k2Container" class="latestView ot-accordion<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<?php foreach($this->blocks as $key=>$block): ?>
			<div class="latestItemsContainer<?php echo $Browsecellwidth; ?>">
				...
				<!-- Start Items list -->
				<div id="latestItemsList" class="latestItemList panel-group">
