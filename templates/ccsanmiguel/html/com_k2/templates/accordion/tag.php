...
<div id="k2Container" class="tagView ot-accordion<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div id="tagItemList" class="tagItemList panel-group">
		<?php foreach($this->items as $item): ?>
			<div class="itemContainer panel">
