...
<div class="latestItemView panel">
	<div class="panel-heading">
		<a href="#latestitem<?php echo $this->item->catid . '-' . $this->item->id; ?>" data-parent="#latestItemsList" data-toggle="collapse" class="panel-toggle">
			<i class="glyphicon glyphicon-chevron-down"></i>
		</a>
		<?php /* if($this->item->params->get('latestItemTitle')): */ ?>
			<!-- Item title -->
			<h4 class="latestItemTitle">
	...
	<div class="panel-collapse collapse" id="latestitem<?php echo $this->item->catid . '-' . $this->item->id; ?>">
