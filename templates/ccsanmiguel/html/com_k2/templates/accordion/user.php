...
<div id="k2Container" class="userView ot-accordion<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<!-- Item list -->
	<div id="userItemList" class="userItemList panel-group">
		<?php foreach ($this->items as $item): ?>		
			<!-- Start K2 Item Layout -->
			<div class="itemContainer panel<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' userItemViewUnpublished'; ?><?php echo ($item->featured) ? ' userItemIsFeatured' : ''; ?>">
				<div class="panel-heading">
					<a href="#item<?php echo $item->catid . '-' . $item->id; ?>" data-parent="#userItemList" data-toggle="collapse" class="panel-toggle">
				...
				<div class="panel-collapse collapse" id="item<?php echo $item->catid . '-' . $item->id; ?>">
