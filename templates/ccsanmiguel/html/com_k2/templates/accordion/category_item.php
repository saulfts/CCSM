...
<div class="panel-heading">
	<!-- <a href="#item<?php echo ucfirst($this->item->itemGroup) . '-' . $this->item->catid . '-' . $this->item->id; ?>" data-toggle="collapse" class="panel-toggle"> -->
	<a href="#item<?php echo ucfirst($this->item->itemGroup) . '-' . $this->item->catid . '-' . $this->item->id; ?>" data-parent="#itemList<?php echo ucfirst($this->item->itemGroup); ?>" data-toggle="collapse" class="panel-toggle">
...
<div class="panel-collapse collapse" id="item<?php echo ucfirst($this->item->itemGroup) . '-' . $this->item->catid . '-' . $this->item->id; ?>">
		...
		<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
			...
			<div class="catItemHeader">
				...
				<span class="catItemDateCreated">
					<i class="glyphicon glyphicon-calendar"></i><?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_LC2')); ?>
				</span>
				<?php endif; ?>
