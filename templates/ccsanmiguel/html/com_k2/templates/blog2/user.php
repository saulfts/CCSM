...
<div id="k2Container" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="userItemList">
		...
		<div class="userItemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' userItemViewUnpublished'; ?><?php echo ($item->featured) ? ' userItemIsFeatured' : ''; ?>">
		  ...
		  <!-- Item Image -->
		  <div class="userItemImageBlock text-center col-xs-12 col-sm-4">
		  ...
		  <?php endif; ?>
			...
			<div class="userItemHeader">	
			  ...
			  <?php endif; ?>
				...
				<?php if($this->params->get('userItemDateCreated') || $this->params->get('userItemCategory') || ($this->params->get('userItemCommentsAnchor') && ( ($this->params->get('comments') == '2' && !$this->user->guest) || ($this->params->get('comments') == '1')) )): ?>
				<div class="userItemInfo">
					...
					<!-- Anchor link to comments below -->
						...
						<?php else: ?>
							...
							<a class="userItemCommentsLink" href="<?php echo $item->link; ?>#itemCommentsAnchor">
								<i class="glyphicon glyphicon-comment"></i>
