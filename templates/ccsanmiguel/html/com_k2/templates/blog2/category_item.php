...
<div class="catItemBlock">
	...
	<?php if($this->item->params->get('catItemImage') && !empty($this->item->image)): ?>
	  <!-- Item Image -->
	  <div class="catItemImage text-center col-xs-12 col-sm-4">
	...
	<div class="catItemHeader">
	  ...
	  <h4 class="catItemTitle">
	  	...
	  	<?php if ($this->item->params->get('catItemTitleLinked')): ?>
			<a class="text-uppercase" href="<?php echo $this->item->link; ?>">
	  ...
	  <?php endif; ?>
		...
		<?php if($this->item->params->get('catItemDateCreated') || $this->item->params->get('catItemAuthor') || $this->item->params->get('catItemHits') || $this->item->params->get('catItemCategory') || ($this->item->params->get('catItemCommentsAnchor') && ( ($this->item->params->get('comments') == '2' && !$this->user->guest) || ($this->item->params->get('comments') == '1')) )): ?>
			<div class="catItemInfo">
				...
				<!-- Anchor link to comments below -->
					<?php if(!empty($this->item->event->K2CommentsCounter)): ?>
						...
						<span class="catItemCommentLink">
							<i class="glyphicon glyphicon-comment"></i>
							<?php echo $this->item->event->K2CommentsCounter; ?>
						</span>
					<?php else: ?>
						<?php if($this->item->numOfComments > 0): ?>
						<a class="catItemCommentLink" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
							<i class="glyphicon glyphicon-comment"></i>
  ...
  <div class="catItemBody">
	  ...
	  <div class="catItemExtraFields">
	  	<h5><?php echo JText::_('K2_ADDITIONAL_INFO'); ?></h5>
	  	<ul>
