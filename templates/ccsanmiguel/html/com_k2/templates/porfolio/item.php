...
<div id="k2Container" class="itemView ot-portfolio<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <!-- Related items by tag -->
	<div class="itemRelated">
		...
		<ul class="list-unstyled row">
			...
			<li class="col-xs-12 col-sm-<?php echo floor (12 / $relcols); ?>">
				<div class="k2ItemBlock oeffect">

					<?php if($this->item->params->get('itemRelatedImageSize')): ?>
						<div class="itemRelImg"><a class="itemRelTitle" href="<?php echo $item->link ?>"><img style="width:<?php echo $item->imageWidth; ?>px;height:auto;" src="<?php echo $item->image; ?>" alt="<?php K2HelperUtilities::cleanHtml($item->title); ?>" /></a></div>
						<div class="clearfix"></div>
					<?php endif; ?>

					<div class="itemRelDesc col-xs-12">
