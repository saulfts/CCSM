		  ...
		  <?php endif; ?>  
			...
			<div class="userItemCommentsLink">
				...
				<?php else: ?>
					...
					<a class="img-circle glyphicon glyphicon-heart" data-toggle="tooltip" href="<?php echo $item->link; ?>#itemCommentsAnchor" title=""<?php echo $item->numOfComments; ?> <?php echo ($item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?>> </a>
					<?php else: ?>
