...
<div class="catItemView oeffect group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">

	<?php if($this->item->params->get('catItemImage') && !empty($this->item->image)): ?>
		<!-- Item Image -->
		<div class="catItemImage text-center">
			<a href="#catItemModal<?php echo $this->item->id; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" data-toggle="modal" data-target="#catItemModal<?php echo $this->item->id; ?>">
	...
	<div class="catItemDesc col-xs-12">
		...
		<div class="catItemHeader">
			...
			<?php if($this->item->params->get('catItemTitle')): ?>
				...
				<h5 class="catItemTitle">
					...
					<?php if ($this->item->params->get('catItemTitleLinked')): ?>
						<a href="#catItemModal<?php echo $this->item->id; ?>" data-toggle="modal" data-target="#catItemModal<?php echo $this->item->id; ?>">
			...
			<?php if($this->item->params->get('catItemHits')): ?>
				<!-- Item Hits -->
				<div class="catItemHits pull-right">
					<span class="catItemHits">
						<a class="img-circle glyphicon glyphicon-eye-open" href="#" data-toggle="tooltip" title="<?php echo JText::_('K2_READ'); ?> <?php echo $this->item->hits; ?> <?php echo JText::_('K2_TIMES'); ?>"> </a>						
					</span>
				</div>
			<?php endif; ?>
			...
			<?php if($this->item->params->get('catItemCommentsAnchor') && ( ($this->item->params->get('comments') == '2' && !$this->user->guest) || ($this->item->params->get('comments') == '1')) ): ?>
				...
				<div class="catItemComments pull-right">
			...
			<?php if($this->item->params->get('catItemDateCreated') || $this->item->params->get('catItemAuthor') || $this->item->params->get('catItemCategory') || ($this->item->params->get('catItemTags') && count($this->item->tags))): ?>
...
<div id="catItemModal<?php echo $this->item->id; ?>" class="modal fade">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="catItemBody">
				<?php if($this->item->params->get('catItemImage') && !empty($this->item->image)): ?>
					<!-- Item Image -->
					<div class="catItemImage text-center col-xs-12 col-sm-7">
				...
				<?php endif; ?>
				<div class="col-xs-12 col-sm-<?php echo ($this->item->params->get('catItemImage') && !empty($this->item->image)) ? '5' : '12'; ?>">
					...
					<div class="catItemHeader">
						...
						<?php if($this->item->params->get('catItemDateCreated') || $this->item->params->get('catItemAuthor') || $this->item->params->get('catItemCategory')): ?>
							<div class="catItemInfo">
								<?php if($this->item->params->get('catItemDateCreated')): ?>
									<!-- Date created -->
									<div class="catItemDateCreated">
					...
					<?php if($this->item->params->get('catItemExtraFields') && count($this->item->extra_fields)): ?>
						...
						<div class="catItemExtraFields">
							<h6><?php echo JText::_('K2_ADDITIONAL_INFO'); ?></h6>
							<ul>
