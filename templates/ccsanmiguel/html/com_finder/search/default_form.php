...
<form id="finder-search" action="<?php echo JRoute::_($this->query->toURI()); ?>" method="get">
	...
	<fieldset class="word form-inline">
		...
		<?php if ($this->escape($this->query->input) != '' || $this->params->get('allow_empty_search')):?>
			<button name="Search" type="submit" class="button btn btn-default"><?php // echo JText::_('JSEARCH_FILTER_SUBMIT');?><span class="glyphicon glyphicon-search"></span></button>
		<?php else: ?>
			<button name="Search" type="" class="button btn btn-default"><?php // echo JText::_('JSEARCH_FILTER_SUBMIT');?><span class="glyphicon glyphicon-search"></span></button>
		<?php endif; ?>
</fieldset>
	...
	<?php if ($this->params->get('show_advanced', 1)): ?>
		<div class="panel-heading">
			<h4 class="panel-title">
				<a id="advanced-search-toggle" data-toggle="collapse" href="#advanced-search"><?php echo JText::_('COM_FINDER_ADVANCED_SEARCH_TOGGLE'); ?></a>
			</h4>
		</div>
