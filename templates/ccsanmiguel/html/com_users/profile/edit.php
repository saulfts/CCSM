...
<?php endforeach;?>
		...
		<div class="form-actions">
			...
			<a class="btn btn-default" href="<?php echo JRoute::_('index.php?option=com_users&view=profile', false); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
