...
<form id="searchForm" class="form-inline" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post">
	...
	<div class="btn-toolbar">
		...
		<div class="btn-group pull-left">
			<button name="Search" onclick="this.form.submit()" class="btn btn-default hasTooltip" title="<?php echo JText::_('COM_SEARCH_SEARCH');?>"><span class="glyphicon glyphicon-search"></span></button>
		</div>
