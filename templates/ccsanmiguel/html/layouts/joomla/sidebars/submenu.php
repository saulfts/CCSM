...
<div id="sidebar">
	<div class="sidebar-nav">
		...
		<div class="filter-select hidden-phone hidden-xs">
			<h4 class="page-header"><?php echo JText::_('JSEARCH_FILTER_LABEL');?></h4>
			<?php foreach ($displayData->filters as $filter) : ?>
				<label for="<?php echo $filter['name']; ?>" class="element-invisible invisible"><?php echo $filter['label']; ?></label>
				<select name="<?php echo $filter['name']; ?>" id="<?php echo $filter['name']; ?>" class="col-xs-12 small" onchange="this.form.submit()">
