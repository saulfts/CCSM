...
<div class="js-stools clearfix">
	<div class="clearfix">
		...
		<div class="js-stools-container-list hidden-phone hidden-tablet hidden-xs hidden-sm">
			<?php echo JLayoutHelper::render('joomla.searchtools.default.list', $data); ?>
		</div>
	</div>
	<!-- Filters div -->
	<div class="js-stools-container-filters hidden-phone hidden-xs clearfix">
