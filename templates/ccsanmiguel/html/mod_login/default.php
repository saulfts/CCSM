...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" class="form-vertical">
	...
	<div class="userdata">
				...
				<?php if (!$params->get('usetext')) : ?>
					<div class="input-group">
						<span class="input-group-addon">
							<span class="glyphicon glyphicon-user tip" title="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?>"></span>
							<label for="modlgn-username" class="element-invisible invisible"><?php echo JText::_('MOD_LOGIN_VALUE_USERNAME'); ?></label>
						</span>
					...
					<div class="input-group">
						<span class="input-group-addon">
							<span class="glyphicon glyphicon-lock tip" title="<?php echo JText::_('JGLOBAL_PASSWORD') ?>">
								...
								<label for="modlgn-passwd" class="element-invisible invisible"><?php echo JText::_('JGLOBAL_PASSWORD'); ?>
							</label>
						</span>
		...
		<div id="form-login-remember" class="control-group form-group checkbox">
		...
		<div id="form-login-submit" class="control-group form-group">
			<div class="controls">
				...
				<button type="submit" tabindex="0" name="Submit" class="btn btn-success btn"><?php echo JText::_('JLOGIN') ?></button>
			</div>
		</div>
		<?php
