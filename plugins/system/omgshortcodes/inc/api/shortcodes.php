...
class Shortcodes_Parser
{
	...
	function render($content) {
		...
		return preg_replace_callback( "/$pattern/s", array($this, 'render_tag'), $content );
	}
	...
	function get_regex() {
		...
		// WARNING! Do not change this regex without changing render_tag() and strip_shortcode_tag()
	...
	public function getContentByModule($modules = "", $modStyle)
	{
		...
		if(!empty($modules))
		{
			...
			$content 	= $this->_renderModule($list, $modStyle);
		}
		return $content;
	}
	
	public function getContentByPosition($position = "", $modStyle)
	{
		$content = "";
		if(!empty($position))
		{
	...
	function _renderModule($list_modules = array(), $modStyle)
	{
		$content="";
